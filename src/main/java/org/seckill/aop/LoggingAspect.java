...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(* org.seckill.service.impl.SeckillServiceImpl.*(..))")
     ...
     * @param joinpoint
     */
    @After("execution(* org.seckill.service.impl.SeckillServiceImpl.*(..))")
     ...
     */
    @AfterReturning(value="execution(* org.seckill.service.impl.SeckillServiceImpl.*(..))", returning="result")
     ...
     * @param e
     */
    @AfterThrowing(value="execution(* org.seckill.service.impl.SeckillServiceImpl.*(..))", throwing="e")
